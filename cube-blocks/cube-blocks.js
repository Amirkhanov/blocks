/*$('.cube-blocks').on('mousemove', 'li', function(e){
    var pos = $(this).offset();
    var posLeft = pos.left;
    var posTop = pos.top;
    var x = e.pageX - posLeft;
    var y = e.pageY - posTop;
    var deg = 90;
    console.log(x);
    console.log(y);
    if (y == 10){
        $(this).find('.item').css("transform", "translateZ(-125px) rotateX(-90deg)");
    }
    if (y == 240){
        $(this).find('.item').css("transform", "translateZ(-125px) rotateX(90deg)");
    }
});*/
/*var pos = $('.cube-blocks li').offset();
var posLeft = pos.left;
var posTop = pos.top;
console.log(posLeft);
console.log(posTop);*/
...
$( function () {
        ...
        function initHeader() {
            ...
            for(var i in points) {
                var c = new Circle(points[i], 2+Math.random()*8, 'rgba(0,0,0,1)');
                points[i].circle = c;
            }
        }
